...
class YamlReader {
     ...
     * @param {object} [options] An options object for further preferences of the file read.
     * @param {string} [options.encoding] The encoding of the file to read. Is utf8 by default.
     * @param {function} [callback] Optional callback. If it is not given, the result will be returned as a promise instead.
     * @returns {Promise<Object>|callback<Object>} The attributes of the yaml file.
     * @throws IllegalArgumentError, FileNotFoundError, InvalidFileExtensionError
     */
    readAsync(pathToYmlFile, options, callback) {
